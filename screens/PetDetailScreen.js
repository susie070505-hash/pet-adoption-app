      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.imageWrapper}>
          ...
          <View style={styles.topBar}>
            ...
            <TouchableOpacity style={styles.iconButton} onPress={() => toggleFavorite(pet.id)}>
              <Ionicons
        ...
        <View style={styles.content}>
          ...
          <View style={styles.orgCard}>
            <View style={styles.orgAvatar}>
              <Text style={styles.orgInitial}>金</Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={styles.orgName}>金毛救援组织</Text>
              <Text style={styles.orgSub}>收容所工作人员在线</Text>
            </View>
            <TouchableOpacity
              style={styles.orgChat}
              onPress={() => navigation.navigate('ChatDetail', { chatId: 'chat-1' })}
            >
